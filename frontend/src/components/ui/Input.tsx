  ...
  return (
    <div className="space-y-1 min-w-0">
      ...
      <input
        ...
        id={id}
        className={clsx(
          "block w-full max-w-full rounded-lg border px-3 py-[9px] text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500",
